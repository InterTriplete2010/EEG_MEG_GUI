function [Buffer1, Buffer2, timearrayout, confarray, comments, s_per, DataPointsNum]=IhsReadwithTime(filepath, external_trigger_check);
  ...
  if ptr1~=-1
    ...
    if (timezeroposition == 0 && external_trigger_check == 0)
