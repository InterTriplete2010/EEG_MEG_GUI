...
% Last Modified by GUIDE v2.5 28-May-2026 11:56:08
...
try
    ...
    [Buffer1, Buffer2, timearrayout, confarray, comments, s_per, DataPointsNum] = IhsReadwithTime(filepath, get(handles.External_Trigger,'Value'));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%If checked, the 0.9 ms compensation for the lenght of the tube of the 
%insert earphone won't be applied
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% --- Executes on button press in External_Trigger.
function External_Trigger_Callback(hObject, eventdata, handles)
% hObject    handle to External_Trigger (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of External_Trigger
