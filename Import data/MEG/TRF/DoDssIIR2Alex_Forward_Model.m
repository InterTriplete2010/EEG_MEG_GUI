...
create_dir = 'Forward_Average_Trials';
...
save_corr_target = ['Forward_Av_Corr_Target_' wav_file_selected(1,1:end-4) '_' num2str(time_shift_DSS(1,integration_windows)) '.mat'];
...
save_corr_noise = ['Forward_Av_Corr_Noise_' wav_file_selected_noise(1,1:end-4) '_' num2str(time_shift_DSS(1,integration_windows)) '.mat'];
