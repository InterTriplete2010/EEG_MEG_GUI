function DoDssIIR2Alex_Single_Trial(Forder,freqL,freqH,order_DSS1,Freq_Low_DSS1,Freq_High_DSS1,wav_file_directory, ...
...
save_std.trial_I = [];
save_corr.trial_I = [];
save_all_corr_cross_val.trial_I = zeros(Subjcet_Number_analysis,10);
...
save_all_corr_cross_val_noise.trial_I = zeros(Subjcet_Number_analysis,10);
...
save_std.trial_II = [];
save_corr.trial_II = [];
save_all_corr_cross_val.trial_II = zeros(Subjcet_Number_analysis,10);
...
save_all_corr_cross_val_noise.trial_II = zeros(Subjcet_Number_analysis,10);
...
save_std.trial_III = [];
save_corr.trial_III = [];
save_all_corr_cross_val.trial_III = zeros(Subjcet_Number_analysis,10);
...
save_all_corr_cross_val_noise.trial_III = zeros(Subjcet_Number_analysis,10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Extracting all the DSS components
...
for wwww = 1:size(x_res_analysis,3)
    ...
    temp_data = squeeze(x_res_analysis(:,:,wwww));
        temp_data(:,1:shift_samples) = [];    
            comp_alg = zeros(length(n_components),shift_samples);
                x_res_analysis(:,:,wwww) = [temp_data comp_alg];

end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%Decoding MEG data for each trial
for mmm = 1:size(x_res_analysis,3)
    
    x_res_analysis_trial = squeeze(x_res_analysis(:,:,mmm));
    [temp_h,CR_test_out,Str_testE, Str_TrainE, Best_iter, Total_Iter, save_max] = svdboostV4_Alex(x_res_analysis_trial,y_res_analysis(1,1:size(x_res_analysis_trial,2)),...
...
[save_max_optimal_filter] = optimal_filter_background_noise(x_res_analysis_trial,y_res_analysis_noise(1,1:size(x_res_analysis_trial,2)),h,cross_folders - 1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save_all_corr_cross_val.trial_I(track_subjects,:) = save_max(2,:);
...
save_optimal_filter.trial_I(:,:,track_subjects) = h;

    case 2
   
        save_all_corr_cross_val.trial_II(track_subjects,:) = save_max(2,:);
...
save_optimal_filter.trial_II(:,:,track_subjects) = h;
        
    case 3
        
        save_all_corr_cross_val.trial_III(track_subjects,:) = save_max(2,:);
...
save_optimal_filter.trial_III(:,:,track_subjects) = h;
...
switch mmm
    ...
    case 1
errorbar(subject_analyzed,save_mean.trial_I,save_std.trial_I)

text(subject_analyzed,save_mean.trial_I,num2str(save_mean.trial_I))

case 2
errorbar(subject_analyzed,save_mean.trial_II,save_std.trial_II)

text(subject_analyzed,save_mean.trial_II,num2str(save_mean.trial_II))

case 3
errorbar(subject_analyzed,save_mean.trial_III,save_std.trial_III)

text(subject_analyzed,save_mean.trial_III,num2str(save_mean.trial_III))
...
switch mmm
    ...
    case 1
errorbar(subject_analyzed,save_median.trial_I,save_std.trial_I)

text(subject_analyzed,save_mean.trial_I,num2str(save_median.trial_I))

case 2
errorbar(subject_analyzed,save_median.trial_II,save_std.trial_II)

text(subject_analyzed,save_mean.trial_II,num2str(save_median.trial_II))

case 3
errorbar(subject_analyzed,save_median.trial_III,save_std.trial_III)

text(subject_analyzed,save_mean.trial_III,num2str(save_median.trial_III))
...
switch mmm
    ...
    case 1
save_all_corr_cross_val_noise.trial_I(track_subjects,:) = save_max_optimal_filter(2,:);
...
case 2
save_all_corr_cross_val_noise.trial_II(track_subjects,:) = save_max_optimal_filter(2,:);
...
case 3
save_all_corr_cross_val_noise.trial_III(track_subjects,:) = save_max_optimal_filter(2,:);
...
switch mmm
    ...
    case 1
errorbar(subject_analyzed,save_mean_noise.trial_I,save_std_noise.trial_I)

text(subject_analyzed,save_mean_noise.trial_I,num2str(save_mean_noise.trial_I))

case 2
errorbar(subject_analyzed,save_mean_noise.trial_II,save_std_noise.trial_II)

text(subject_analyzed,save_mean_noise.trial_II,num2str(save_mean_noise.trial_II))

case 3
errorbar(subject_analyzed,save_mean_noise.trial_III,save_std_noise.trial_III)

text(subject_analyzed,save_mean_noise.trial_III,num2str(save_mean_noise.trial_III))
...
switch mmm
    ...
    case 1
errorbar(subject_analyzed,save_median_noise.trial_I,save_std_noise.trial_I)

text(subject_analyzed,save_median_noise.trial_I,num2str(save_median_noise.trial_I))

 case 2
errorbar(subject_analyzed,save_median_noise.trial_II,save_std_noise.trial_II)

text(subject_analyzed,save_median_noise.trial_II,num2str(save_median_noise.trial_II))

case 3
errorbar(subject_analyzed,save_median_noise.trial_III,save_std_noise.trial_III)

text(subject_analyzed,save_median_noise.trial_III,num2str(save_median_noise.trial_III))
...
create_dir = 'Save_Single_Backward_Corr_Quiet';
...
save_corr_target = ['Backwards_Trials_Corr_Target_' wav_file_selected(1,1:end-4) '_' num2str(time_shift_DSS(1,integration_windows)) '.mat'];
...
save_corr_noise = ['Backward_Trials_Corr_Noise_' wav_file_selected_noise(1,1:end-4) '_' num2str(time_shift_DSS(1,integration_windows)) '.mat'];

save(save_corr_noise,'save_mean_data_noise')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

close(2000 + integration_windows)
