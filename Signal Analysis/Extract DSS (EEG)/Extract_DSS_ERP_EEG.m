...
% Last Modified by GUIDE v2.5 26-Sep-2025 09:47:52
...
phase_filter = get(handles.Phase_Filter_DSS,'Value');
...
DSS_EEG(DSS_EEG_file_directory,start_p1_time,end_p1_time,start_N100_time,end_N100_time,start_P200_time,end_P200_time,file_name_peaks_latencies,...
    sweeps_analysis_DSS,filter_DSS_var,hcf,lcf,order_f,phase_filter)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Select if to apply a zero-phase filter
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% --- Executes on selection change in Phase_Filter_DSS.
function Phase_Filter_DSS_Callback(hObject, eventdata, handles)
% hObject    handle to Phase_Filter_DSS (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns Phase_Filter_DSS contents as cell array
%        contents{get(hObject,'Value')} returns selected item from Phase_Filter_DSS


% --- Executes during object creation, after setting all properties.
function Phase_Filter_DSS_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Phase_Filter_DSS (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
