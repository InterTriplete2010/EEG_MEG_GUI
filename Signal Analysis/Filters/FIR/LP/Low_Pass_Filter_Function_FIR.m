function eeg_filtered = Low_Pass_Filter_Function_FIR (eeg_data_filter,cut_off_high,sampling_frequency_data,order_high_pass);
...
try
  ...
  b = fir1(order_high_pass,(cut_off_high)/(sampling_frequency_data/2),'low'); 
  a = 1;
