function eeg_filtered = Band_Pass_Filter_Function_FIR (eeg_data_filter,cut_off_band_pass_low,cut_off_band_pass_high,sampling_frequency_data,order_band_pass); 
...
try
  ...
  b = fir1(order_band_pass,[cut_off_band_pass_high cut_off_band_pass_low]/(sampling_frequency_data/2)); 
  a = 1;
