function eeg_filtered = Band_Stop_Filter_Function_COGMO (eeg_data_filter,cut_off_band_stop_low,cut_off_band_stop_high,sampling_frequency_data,order_band_stop,zp_option); 
...
try
  ...
  [b,a] = butter(order_band_stop,[cut_off_band_stop_high cut_off_band_stop_low]/(sampling_frequency_data/2),'stop'); 
  %Butterworth filter: order = order_band_stop; Cutoff Frequency: [cut_off_low_value cut_off_high_value]; 
  %band stop filter
