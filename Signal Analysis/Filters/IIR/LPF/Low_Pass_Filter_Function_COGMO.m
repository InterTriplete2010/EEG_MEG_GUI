function eeg_filtered = Low_Pass_Filter_Function_COGMO (eeg_data_filter,cut_off_low_pass,sampling_frequency_data,order_low_pass,zp_option); 
...
try
  ...
  [b,a] = butter(order_low_pass,cut_off_low_pass/(sampling_frequency_data/2),'low'); 
  %Butterworth filter: order = order_low_pass; Cutoff Frequency: cut_off_low_pass; 
  %low pass filter
