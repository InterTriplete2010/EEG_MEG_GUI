...
% Last Modified by GUIDE v2.5 05-Sep-2025 12:28:44
...
msgbox(message,'Operation aborted','warn','replace');
 ...
 check_baseline_correction = get(handles.Baseline_Correction,'Value');
 time_baseline_correction = str2double(get(handles.Time_Baseline_Correction,'String'))/1000;
...
% Hint: get(hObject,'Value') returns toggle state of Baseline_Correction


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Time window to average for the baseline correction
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Time_Baseline_Correction_Callback(hObject, eventdata, handles)
% hObject    handle to Time_Baseline_Correction (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Time_Baseline_Correction as text
%        str2double(get(hObject,'String')) returns contents of Time_Baseline_Correction as a double
...
% --- Executes during object creation, after setting all properties.
function Time_Baseline_Correction_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Time_Baseline_Correction (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
